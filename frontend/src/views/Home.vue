...
const s = reactive({
  ...
  orangeTag: { background: 'var(--brand-primary, #5BAEDC)', color: '#fff', padding: '4px 10px', fontWeight: '700', letterSpacing: '1px', fontSize: '0.75rem' },
  ...
  highlightOrange: { color: 'var(--brand-primary, #5BAEDC)', fontWeight: '700', fontFamily: mono },
  ...
  sloganText: { fontSize: '1.2rem', fontWeight: '520', color: '#000', letterSpacing: '1px', borderLeft: '3px solid var(--brand-primary, #5BAEDC)', paddingLeft: '15px', marginTop: '20px' },
  blinkingCursor: { color: 'var(--brand-primary, #5BAEDC)', fontWeight: '700' },
  decorationSquare: { width: '16px', height: '16px', background: 'var(--brand-primary, #5BAEDC)' },
  ...
  scrollDownBtn: { width: '40px', height: '40px', border: '1px solid #E5E5E5', background: 'transparent', display: 'flex', alignItems: 'center', justifyContent: 'center', cursor: 'pointer', color: 'var(--brand-primary, #5BAEDC)', fontSize: '1.2rem' },
  ...
  statusDot: { color: 'var(--brand-primary, #5BAEDC)', fontSize: '0.8rem' },
