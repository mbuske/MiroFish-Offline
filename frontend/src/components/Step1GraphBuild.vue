  ...
  <div class="workbench-panel">
          ...
          <div v-if="selectedOntologyItem" class="ontology-detail-overlay">
            <div class="detail-header">
               <div class="detail-title-group">
                  <span class="detail-type-badge">{{ selectedOntologyItem.itemType === 'entity' ? $t('step1x.entity') : $t('step1x.relation') }}</span>
            ...
            <div class="detail-body">
               ...
               <div class="detail-section" v-if="selectedOntologyItem.attributes?.length">
                  <span class="section-label">{{ $t('step1x.attributes') }}</span>
                  <div class="attr-list">
               ...
               <div class="detail-section" v-if="selectedOntologyItem.examples?.length">
                  <span class="section-label">{{ $t('step1x.examples') }}</span>
               ...
               <div class="detail-section" v-if="selectedOntologyItem.source_targets?.length">
                  <span class="section-label">{{ $t('step1x.connections') }}</span>
                  <div class="conn-list">
    ...
    <div class="system-logs">
      <div class="log-header">
        <span class="log-title">{{ $t('step1x.systemDashboard') }}</span>
        <span class="log-id">{{ projectData?.project_id || $t('step1x.noProject') }}</span>
      </div>
